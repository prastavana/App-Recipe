...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Login'),
        backgroundColor:Color(0xFFc6b7fe),
      ),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Email',
                  prefixIcon: Icon(Icons.email, color: Color(0xFFc6b7fe),),
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Color(0xFFc6b7fe),),
                  ),
                ),
              ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Password',
                  prefixIcon: Icon(Icons.lock, color: Color(0xFFc6b7fe),),
                  enabledBorder: OutlineInputBorder(
                    borderSide: BorderSide(color:Color(0xFFc6b7fe),),
                  ),
                ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  foregroundColor: Colors.black, backgroundColor: Color(0xFFc6b7fe),
              ...
              OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  side: BorderSide(color: Color(0xFFc6b7fe),),
                  padding: EdgeInsets.symmetric(horizontal: Dimensions.width40, vertical: Dimensions.height12),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(Dimensions.radius24),
                  ),
